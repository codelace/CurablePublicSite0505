...
export const themeExtensions = {
  ...
  colors: {
    ...
    // Enhanced quantum rainbow palette for rich UX
    ...
    'quantum-sapphire': 'hsl(var(--quantum-sapphire))',
  },
  fontFamily: {
  ...
  backgroundImage: {
    ...backgroundImages,
    'gradient-quantum-primary': 'var(--gradient-quantum-primary)',
    'gradient-quantum-secondary': 'var(--gradient-quantum-secondary)',
    'gradient-quantum-accent': 'var(--gradient-quantum-accent)',
    'gradient-quantum-aurora': 'var(--gradient-quantum-aurora)',
    'gradient-quantum-spectrum': 'var(--gradient-quantum-spectrum)',
    'gradient-quantum-flow': 'var(--gradient-quantum-flow)',
    'gradient-quantum-mesh': 'var(--gradient-quantum-mesh)',
