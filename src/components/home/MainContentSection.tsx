    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className={`transition-all duration-500 delay-300 ${revealSections.includes('tabs') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="relative min-h-[12rem] card-quantum-optimized bg-brand-charcoal/30 backdrop-blur-lg border border-electric-quantum-blue/25 rounded-xl p-6 shadow-xl shadow-electric-quantum-blue/20">
        ...
        <div className={`flex justify-center mt-6 transition-all duration-700 delay-400 ${revealSections.includes('tabs') ? 'opacity-100' : 'opacity-0'}`}>
          <div className="magnetic-attraction flex flex-col items-center text-foreground/40 hover:text-electric-quantum-blue transition-colors duration-300 group">
            <ChevronDown className="w-5 h-5 animate-bounce group-hover:text-electric-quantum-blue" />
            <span className="text-sm font-poppins font-medium mt-1 group-hover:text-electric-quantum-blue">Scroll to explore</span>
          </div>
        </div>
      </div>
    </div>
