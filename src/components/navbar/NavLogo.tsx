  ...
  return (
    <div className="flex items-center">
      ...
      <div className="relative ml-2">
        <div className="absolute -inset-1 bg-bio-blue/20 rounded-full blur-sm animate-pulse"></div>
        <div className="relative w-2 h-2 rounded-full bg-bio-blue/20 animate-pulse-dot"></div>
        {/* Add pulsing ring */}
