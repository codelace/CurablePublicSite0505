...
export const ActionButtons = ({ className = "", isMobile = false }: ActionButtonsProps) => {
  ...
  const dnaButtonClasses = isMobile
    ? "flex items-center justify-center bg-purple-600 hover:bg-purple-700 py-3 rounded-lg text-white font-bold text-base mb-4"
    : "flex items-center bg-purple-600 hover:bg-purple-700 px-4 py-2 rounded-lg text-white font-bold text-lg transition-all duration-300 hover:scale-105 hover:shadow-[0_0_15px_rgba(147,51,234,0.5)]";
