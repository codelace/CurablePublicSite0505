...
const AnimatedCircuitLines: React.FC = () => {
  return (
    <div className="absolute inset-0 pointer-events-none z-0">
      ...
      <div className="absolute top-[10%] left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-quantum-cyan/40 to-transparent data-flow will-change-transform"></div>
      ...
      <div className="absolute left-[75%] top-0 h-full w-[1px] bg-gradient-to-b from-transparent via-quantum-teal/30 to-transparent data-flow-vertical will-change-transform" style={{animationDuration: "12s"}}></div>
      
      {/* Connection nodes */}
      <div className="absolute top-[30%] left-[15%] w-3 h-3 rounded-full bg-logo-blue/50 animate-pulse-dot"></div>
      <div className="absolute top-[50%] left-[75%] w-3 h-3 rounded-full bg-quantum-purple/60 animate-pulse-dot will-change-transform" style={{animationDelay: "1s"}}></div>
      ...
      <div className="absolute bottom-[30%] left-[20%] w-40 h-40 rounded-full bg-quantum-mint/8 blur-3xl animate-pulse-glow will-change-transform" style={{animationDelay: "2s"}}></div>
    </div>
  );
};
