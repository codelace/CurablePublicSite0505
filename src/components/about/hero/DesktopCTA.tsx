  ...
  return (
    <div className="relative group">
      ...
      <a 
        ...
        className="relative bg-dark-surface hover:bg-gunmetal-900 text-white font-medium flex items-center gap-2 font-mono border border-logo-blue/30 transition-all duration-500 text-sm py-1.5 px-3 rounded-lg hover:scale-[1.03] whitespace-nowrap"
      >
