...
const HeroSection: React.FC<HeroSectionProps> = ({ mounted, revealSections, scrollToContent }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-320px)] pb-2">
      ...
      <div className="mb-4 text-center max-w-5xl mx-auto">
        ...
        <p className={`text-titanium-white/80 max-w-3xl mx-auto text-sm sm:text-base leading-relaxed mb-4 mt-2 transition-all duration-700 delay-300 transform ${revealSections.includes('hero-text') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className={`flex flex-wrap justify-center gap-2 sm:gap-3 transition-all duration-700 delay-400 transform ${revealSections.includes('hero-text') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <Link 
            to="/about"
            className="group relative px-4 py-2 bg-logo-blue hover:bg-logo-blue/90 text-white font-bold rounded-lg overflow-hidden transition-all duration-500 hover:shadow-[0_0_25px_rgba(30,174,219,0.4)] hover:scale-105"
          >
          ...
          <Link 
            to="/whitepaper"
            className="px-4 py-2 bg-transparent border-2 border-titanium-white/30 hover:border-titanium-white/70 text-titanium-white font-bold rounded-lg transition-all duration-500 hover:shadow-[0_0_15px_rgba(232,241,249,0.15)] hover:scale-105"
          >
            Read Whitepaper
          </Link>
        </div>
      ...
      <div className={`absolute bottom-4 left-1/2 transform -translate-x-1/2 transition-all duration-700 delay-500 ${revealSections.includes('hero-text') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
        <button 
