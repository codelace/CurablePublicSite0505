...
const MagneticCard = ({
  ...
  className,
  strength = 5,
  glowColor = 'rgba(255, 87, 87, 0.4)', // quantum-red glow
  glowRadius = 15,
  scale = 1.02,
  borderColor = 'quantum-red',
  ...
  const getBorderClass = () => {
    switch (borderColor) {
      case 'quantum-red': return 'border-quantum-red/40';
      ...
      default: return 'border-quantum-red/40';
    }
  };
    ...
    >
      ...
      {isHovering && (
        <div className="absolute inset-0 -z-10 rounded-lg pointer-events-none overflow-hidden">
          <div className="absolute inset-0 bg-gradient-radial from-quantum-red/20 via-transparent to-transparent opacity-70"></div>
          <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-quantum-red/40 to-transparent"></div>
