  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {/* Enhanced gradient overlay with quantum spectrum */}
        <div className="absolute inset-0 bg-gradient-to-br from-quantum-red/6 via-molecular-bright/4 to-molecular-accent/6"></div>
        ...
        {/* Optimized glowing orbs with quantum color spectrum */}
        ...
        <div className="absolute bottom-[25%] left-[15%] w-80 h-80 rounded-full bg-molecular-bright/6 blur-3xl animate-pulse-glow magnetic-attraction-optimized" style={{animationDelay: '2s'}}></div>
        <div className="absolute top-[60%] right-[10%] w-48 h-48 rounded-full bg-molecular-accent/5 blur-3xl animate-pulse-glow magnetic-attraction-optimized" style={{animationDelay: '4s'}}></div>
      </div>
