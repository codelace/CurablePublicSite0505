...
const ValueCard: React.FC<ValueCardProps> = ({ value, isHovered }) => {
  ...
  const iconMap = {
    transparency: (
      <svg className={`w-8 h-8 text-blue-400 transition-all duration-500 ${isHovered ? 'scale-110 text-blue-300' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
